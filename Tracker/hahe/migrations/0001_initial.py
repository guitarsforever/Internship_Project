# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-08-10 00:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Device_Category', models.CharField(choices=[('HE', 'HE'), ('HA', 'HA')], default='', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Task', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='hahe.Task')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completed', hahe.models.IntegerRangeField(default=0)),
                ('Status', models.CharField(choices=[('On Time', 'On Time'), ('At Risk', 'At Risk'), ('Delayed', 'Delayed')], default='On_Time', max_length=10)),
                ('Product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='hahe.Product')),
            ],
        ),
        migrations.AddField(
            model_name='task',
            name='team',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='hahe.Team'),
        ),
    ]
